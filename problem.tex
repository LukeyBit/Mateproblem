...
För att designa två liknande skålar vars respektive volym är 3 liter använder vi processen för uppgift 1 omvänd. Vi börjar med att ställa upp en ekvation för volymen av skålen, $V$ som i detta fall är 3 liter eller 3000 cm$^3$:
...
\newpage
Vi kan nu skriva om formeln $3000=\pi\int_{0}^{13}{g(y)}^2dy$:

\begin{align*}
    3000&=\pi\int_{0}^{13}{h(y)}dy\\
    3000&=\pi\int_{0}^{13}{h(y)}dy\Rightarrow 3000=\pi{\left[{H(y)}\right]}_{0}^{l}\\
\end{align*}
